...
<div class="d-flex row mt-5 mx-auto">
    <div class="card col-md-5 col-lg-4 col-xl-2 mx-auto mb-4 text-center pt-3">
        <img src="{{ asset('imgs/wtp.png') }}" alt="" class="card-img-top mx-auto" style="width: 150px">
        <div class="card-body">
    ...
    <div class="card col-md-5 col-lg-4 col-xl-2 mx-auto mb-4 text-center pt-3">
        <img src="{{ asset('imgs/gmail.png') }}" alt="" class="card-img-top mx-auto" style="width: 150px">
        <div class="card-body">
    ...
    <div class="card col-md-5 col-lg-4 col-xl-2 mx-auto mb-4 text-center pt-3">
        <img src="{{ asset('imgs/insta.png') }}" alt="" class="card-img-top mx-auto" style="width: 150px">
        <div class="card-body">
    ...
    <div class="card col-md-5 col-lg-4 col-xl-2 mx-auto mb-4 text-center pt-3">
        <img src="{{ asset('imgs/fb.png') }}" alt="" class="card-img-top mx-auto" style="width: 150px">
        <div class="card-body">
    ...
    <div class="card col-md-5 col-lg-4 col-xl-2 mx-auto mb-4 text-center pt-3">
        <img src="{{ asset('imgs/tiktok.png') }}" alt="" class="card-img-top mx-auto" style="width: 150px">
        <div class="card-body">
